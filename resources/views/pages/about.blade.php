...
<div class="w-full">
  ...
  <div class="flex bg-blue-200" style="height:600px;">
      <div class="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
          <div>
              <h2 class="text-3xl font-semibold text-gray-800 md:text-4xl">Our <span class="text-indigo-600">Mission</span></h2>
              <p class="mt-2 text-sm text-gray-600 md:text-base"> Our mission at RailReady is to transform the way you book train tickets, making it a hassle-free and enjoyable experience. We strive to connect travelers with their desired destinations by offering a user-friendly platform, exceptional customer service, and innovative solutions.</p>
      ...
      <div class="hidden lg:block lg:w-1/2" style="clip-path:polygon(10% 0, 100% 0%, 100% 100%, 0 100%)">
          <div class="h-full object-cover" style="background-image: url(img/station.jpg)">
        ...
        <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
          ...
          <figure class="relative isolate">
            ...
            <blockquote class="mt-6 text-xl font-semibold leading-8 text-white">
              <p>“At RailReady, we envision a world where booking train tickets is as simple as a click. We aim to be the go-to platform for travelers seeking convenience, reliability, and personalized travel.”</p>
            </blockquote>
            <figcaption class="mt-6 text-sm leading-6 text-gray-300"><strong class="font-semibold text-white">Medan Rosa,</strong> ceo of Rail Ready</figcaption>
          </figure>
        </div>
      </div>
      <div>
        <div class="text-base leading-7 text-gray-700 lg:max-w-lg">
          <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Smooth Journeys Awaits</h1>
          <div class="max-w-xl">
            <p class="mt-6">You won't experience the true tranquility of a smooth journey unless every aspect of your travel is meticulously planned and executed.</p>
            <p class="mt-8">Just like balancing your time between prayer, leisure, work, and study, ensure your travel plans are well-organized and seamless.</p>
            <p class="mt-8">For a serene journey, tackle ticket issues promptly and plan your travel wisely. Allocate time for booking, packing, and savoring the anticipation. With everything in order, embark on your train journey confidently.</p>
          </div>
        </div>
        <dl class="mt-10 grid grid-cols-2 gap-8 border-t border-gray-900/10 pt-10 sm:grid-cols-4">
          ...
          <div>
            ...
            <dd class="mt-2 text-3xl font-bold leading-10 tracking-tight text-gray-900"> 1</dd>
          </div>
          <div>
            <dt class="text-sm font-semibold leading-6 text-gray-600">Raised</dt>
            <dd class="mt-2 text-3xl font-bold leading-10 tracking-tight text-gray-900">private funding</dd>
          </div>
        </dl>
