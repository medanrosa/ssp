                        ...
                        <div class="flex-auto justify-evenly">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center my-1">
                                    <span class="mr-3 rounded-full bg-white w-8 h-8">
                                        <img src="{{url('img/trainticket3.jpg') }}">
                                    </span>
                                    <h2 class="font-medium">RailReady</h2>
                                </div>
                            ...
                            <div class="flex items-center">
                                <div class="flex flex-col">
                                    ...
                                    <div class="w-full flex-none text-lg text-blue-800 font-bold leading-none">{{ $ticket->departure }}</div>
                                    <div class="text-xs">{{ $ticket->departure }}</div>
                                </div>
                                <div class="flex flex-col mx-auto">
                                    <img src="{{url('img/trainticket2.png') }}" class="w-20 p-1">
                                </div>
                                <div class="flex flex-col">
                                    <div class="flex-auto text-xs text-gray-400 my-1">
                                        <span class="mr-1">MO</span><span>19 22</span>
                                    ...
                                    <div class="text-xs">{{ $ticket->destination }}</div>
                                </div>
                            </div>
...
{{--                            </div>--}}
                            ...
                            <div class="flex items-center px-5 pt-3 text-sm">
                                ...
                                <div class="flex flex-col mx-auto">
                                    <span>Class</span>
                                    <div class="font-semibold">{{ $ticket->class }}</div>
                                </div>
                                <div class="flex flex-col">
                                    <span>Time Slot</span>
                                    <div class="font-semibold">{{ $ticket->time_slot }}</div>
                                </div>
                            </div>
                            ...
                            <div class="text-center mt-4">
                                <button onclick="window.print();" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Print Receipt</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <br><br>
        <a href="/" class="inline-block text-white font-bold py-5 px-20 rounded-full bg-gradient-to-r from-blue-300 to-gray-700 border border-transparent transform hover:scale-110 hover:border-white transition-transform duration-3000 ease-in-out ml-4">
            Home
        </a>
    </div>
